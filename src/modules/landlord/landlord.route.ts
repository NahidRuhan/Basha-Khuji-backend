...
router.patch("/properties/:propertyId",auth(UserRole.LANDLORD),landlordController.deleteProperty)
...
router.get("/tenant-history/:userId",auth(UserRole.LANDLORD),landlordController.getTenantHistory)
